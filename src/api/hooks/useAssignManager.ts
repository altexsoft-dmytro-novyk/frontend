 ...
 *
 * On success the access-journal query and the sibling profile card query are
 * invalidated so both reflect the new edge (the card query is not mounted on
 * this screen, but the profile screen re-reads it fresh).
 */
